...
<%
    ...
    try {
        usuarios = dao.selectUsuario("si", "apellidos");
    } catch (Exception ex) {
        message = ex.toString();
    }
%>
...
<html>
    <head>
        ...
        <title>V2formDarBajaUsuario1</title>
    ...
    <body>   
        <div class="titulo">
            ...
            <div id="menu">
                ...
                <form id="formulario" action="V2formDarBajaUsuario2.jsp" method="POST">
                    <fieldset>
                        ...
                        <input type="submit" class="boton_final" value="Dar de baja"> 
                    </fieldset>
                </form>  
                <form>
                    <%if (!message.isEmpty()) {%>
